...
|3.7Vリチウムポリマーバッテリー|2個|603048型（厚さ6.3mm幅48mm長さ30mm以下）、JST PHコネクタ（ソケットのピッチ2.0mm）※[ソケットの極性に注意！](https://github.com/ShiniNet/LaLaPadGen2/blob/main/guide/BuildGuide.md#%E3%83%90%E3%83%83%E3%83%86%E3%83%AA%E3%83%BC%E5%8B%95%E4%BD%9C%E7%A2%BA%E8%AA%8D) ※初代LaLapadのバッテリーを流用可能|[Amazon](https://www.amazon.co.jp/dp/B09YQ1Y3CY) [PHコネクタ単品](https://www.amazon.co.jp/dp/B01MXGWMS5/)|
...
|中|ミニホットプレート|トラブル時にマイコンやICを取り外すために必須です。本ビルドガイドでは250℃前後出せるもので十分です。PD65W以上に対応したUSB-C充電器とケーブルが必要です。ヒートガンでも代用可能。|[amazon](https://www.amazon.co.jp/dp/B0DGFFP4CG/)|
|中|はんだペースト|トラックパッドICのはんだ付けを直す用。| [amazon](https://www.amazon.co.jp/dp/B0DFCN6P2X/)|
...
> [!WARNING]
> - Amazonのリンクに関して、在庫切れが生じると自動的に別バリエーションへ誘導される事象を確認しております。参考リンクに掲載された製品をそのまま買う前に、ビルドガイドの仕様と一致しているかをご確認いただけますようお願い申し上げます。
...
## トラックパッドは動作するが安定しない
- 異なるマシン（PC、スマホ、タブレット）で同様の問題が起こるかチェック（環境原因
- FFCを左右で付け替えて、接触不良や初期不良チェックする
- トラックパッドを左右で付け替えて、症状が移転するかチェック（移転する＝トラパ側原因
- 置き場所で動作するかチェック（周辺の大きな金属によるセンサー異常など
- ICの4辺にフラックスを塗布し、はんだゴテでピンを撫でてはんだクラック等を修正する。
- 「[故障したトラックパッド基板を修理する](https://github.com/ShiniNet/LaLaPadGen2/blob/main/guide/BuildGuide.md#%E6%95%85%E9%9A%9C%E3%81%97%E3%81%9F%E3%83%88%E3%83%A9%E3%83%83%E3%82%AF%E3%83%91%E3%83%83%E3%83%89%E5%9F%BA%E6%9D%BF%E3%82%92%E4%BF%AE%E7%90%86%E3%81%99%E3%82%8B%E3%81%AF%E3%82%93%E3%81%A0%E3%81%94%E3%81%A6%E3%81%AF%E3%82%93%E3%81%A0%E3%83%9A%E3%83%BC%E3%82%B9%E3%83%88%E3%83%9F%E3%83%8B%E3%83%9B%E3%83%83%E3%83%88%E3%83%97%E3%83%AC%E3%83%BC%E3%83%88%E4%BD%BF%E7%94%A8)」へ
- それでも問題の解決しない、解決が難しい場合はお問合せください
...
- 最新のファームウェアを使用していますか？[ファームウェアリポジトリのリリースページを開き、一番上にあるファームウェア](https://github.com/ShiniNet/zmk-config-LalaPadGen2/releases/)を取得して、再試行してみてください。
...
- ミニホットプレートの設定温度を200℃に設定します。※有鉛低温はんだを使用している前提です
...
## 故障したトラックパッド基板を修理する（はんだごて＆はんだペースト＆ミニホットプレート使用）
- ミニホットプレートの設定温度を250～℃に設定します。
- トラパPCBのICにフラックスを塗布します。
- ミニホットプレートにトラパPCBを載せて加熱＆ICの四辺や上面からはんだごてで加熱を助けます。
- 十分に加熱されるとICが動くので、ピンセットでICをとりはずし、はんだ吸い取り線でPCBやICの余剰はんだを除去します。※単なるはんだクラックであれば、加熱だけで治るケースも。
- 一度ホットプレートからPCBをおろして、はんだペーストを適量PCBのパターンに塗布します。
- ICの向き（PCBとICにプリントされた丸いドットの位置を合わせる）に注意しつつ、ピンセットでPCBのパターンにICを載せます。
- 再びホットプレートでPCBを加熱（低温はんだペーストを使うなら200度前後）し、はんだペーストが溶けてICがニュルンと表面張力で動いたら完了。
- ホットプレートからPCBをおろして、トラパケースにトラパPCBをセットし、キーボードと接続して動作確認します。

<img width="1023" height="450" alt="image" src="https://github.com/user-attachments/assets/b1124936-2b2f-4ee0-89e7-6e177c71d41d" />
